    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId=3, Name="Fusil",Description="Arme de loin",Force=100,Image= "https://groupepronature.ca/cdn/shop/files/ALTOBELLI_fusil1coupnoir_1254x1254.png?v=1786979706", Price=600,Qty=13,QtyBought=1, CreatedDate=new DateTime(2026,09,17) }
            );
            #endregion
        }
    }
